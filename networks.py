...
class WGAN_VGG_discriminator(nn.Module):
    def __init__(self, input_size):
        ...
        self.residual_block = ResidualBlock(256, 256)

        # [3]*6=>[3,3,3,3,3,3] [1,2]*3 =>[1,2,1,2,1,2]
...
class WGAN_VGG(nn.Module):
    ...
    def gp(self, y, fake, lambda_=10):
        ...
        a = torch.tensor(np.random.random((y.size(0), 1, 1, 1)), dtype=torch.float32, device='cuda')
